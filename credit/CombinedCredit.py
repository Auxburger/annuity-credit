...
class CombinedCredit:
    ...
    def __init__(self, capitals, rate, redemption, sredemption, years, paid, cost):
        self.d1 = Credit(capitals[0], rate, redemption, sredemption, years, paid[0], cost[0])
        self.d2 = Credit(capitals[1], rate, redemption, sredemption, years, paid[1], cost[1])
        self.years = years
    ...
    def add_post_credit(self, rate, redemption, sredemption, years):
        ...
        self.post_credit = CombinedCredit([remaining_credit1, remaining_credit2], rate, redemption, sredemption, years,
                                          paid, cost)
    ...
    def print_yearly(self):
        ...
        for i in range(len(yearly[0])):
            rate = yearly[0][i]
            redemption = yearly[1][i]
            capital = yearly[2][i]
            print(f"-{rate:.2f}\t\t\t+{redemption:.2f}\t\t={capital:.2f}")
    ...
    def print_total(self):
        ...
        capital = total[2][0]
        print(
            f"Total {self.years, self.capitals, self.rate}:\t\t ~{self.annuity}\t\t -{rate:.2f}\t\t\t+{redemption:.2f}\t\t={capital:.2f}")
